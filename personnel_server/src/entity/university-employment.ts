...
export class UniversityEmployment {
  ...
  @Column({ name: 'date_of_accept', type: 'date', nullable: true })
  dateOfAccept: Date;

  @Column({ name: 'date_of_position_start', type: 'date', nullable: true })
  ...
  @Column({ name: 'work_mode_id', nullable: true })
  workModeId: number;

  @Column({ name: 'total_experience_years', type: 'int', nullable: true })
  totalExperienceYears: number;

  @Column({ name: 'continuous_work_years', type: 'int', nullable: true })
  continuousWorkYears: number;

  @Column({ name: 'employment_contract', type: 'varchar', length: 255, nullable: true })
  employmentContract: string;

  @Column({ name: 'employment_contract_end_date', type: 'date', nullable: true })
  employmentContractEndDate: Date;

  @Column({ name: 'previous_jobs', type: 'text', nullable: true })
  previousJobs: string;
